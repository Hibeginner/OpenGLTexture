	...
	_In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_OPENGLTEXTURE, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_OPENGLTEXTURE));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDC_OPENGLTEXTURE));
